    ...
    public class RestServicePromo
    {
        ...
        public async Task<List<ValueN>> GetWeatherData2Async()
        {
            try
            {
                ...
                HttpResponseMessage responses = await httpClient.GetAsync("atx_promocions?$select=atx_name,atx_descripcion,atx_validadesde,atx_validahasta,createdby&$orderby=atx_validadesde&$filter=statecodeeq0");
